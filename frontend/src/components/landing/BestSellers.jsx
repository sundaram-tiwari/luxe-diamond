    ...
    <section className="py-5">
      <div className="container">
        ...
        <div className="scroll-section-wrapper">
          ...
          <div
            className="bestsellers-scroll-container"
          ...
          >
            <div className="bestsellers-scroll-wrapper">
                  ...
                  <div key={product._id} className="bestseller-card">
                    <div className="card border-0 text-center h-100">
                      ...
                      <div className="card-body">
                        ...
                        <p className="fw-bold text-primary">₹{product.productBuyPrice}</p>
                        <button
      ...
      <style>{`
        ...
        .bestsellers-scroll-container.grabbing {
          cursor: grabbing;
        }
        ...
        .bestseller-card .product-detail-link {
          opacity: 1;
          filter: none;
          display: block;
        }
